...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        v3.x = other1.y * other2.z - other1.z * other2.y; 
        v3.y = other1.z * other2.x - other1.x * other2.z; 
        v3.z = other1.x * other2.y - other1.y * other2.x; 
    ...
    magnitude() {
        ...
        let z2 = this.elements[2]; 

        let m = Math.sqrt(z2 * z2 + y1 * y1 + x0 * x0); 
        console.log("Magnitude is ", m); 
